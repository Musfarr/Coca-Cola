...
const Recorder = () => {
  ...
  return (
    <div style={{height:"100vh" , paddingLeft:"15vh" , paddingTop:"30px" , backgroundColor:"#f5f5f5"}}> 
    ...
    <ul class="flex flex-wrap -mb-px text-lg font-medium text-center  " id="tabExample" role="tablist">
        <li class="mr-2" role="presentation">
            <button class="inline-block p-4 underline  text-red hover:text-grY hover:border-gray-300 " id="profile-tab-example" type="button" role="tab" aria-controls="profile-example" aria-selected="false">Profile</button>
        </li>
        <li class="mr-2" role="presentation">
            <button class="inline-block p-4 underline  hover:text-gray-600 hover:border-gray-300 " id="dashboard-tab-example" type="button" role="tab" aria-controls="dashboard-example" aria-selected="false">Dashboard</button>
        </li>
        <li class="mr-2" role="presentation">
            <button class="inline-block p-4 underline  hover:text-gray-600 hover:border-gray-300 " id="settings-tab-example" type="button" role="tab" aria-controls="settings-example" aria-selected="false">Settings</button>
        </li>
        <li role="presentation">
            <button class="inline-block p-4 underline  hover:text-gray-600 hover:border-gray-300 " id="contacts-tab-example" type="button" role="tab" aria-controls="contacts-example" aria-selected="false">Contacts</button>
        </li>
    </ul>
</div>
